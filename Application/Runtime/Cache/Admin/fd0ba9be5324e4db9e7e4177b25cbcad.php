    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="<?php echo U('AuthGroup/edit');?>">
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">用户组名称</label>
                            <div class="col-lg-10">
