    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="<?php echo U('News/catEdit');?>">
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">上级分类</label>
                            <div class="col-lg-10">
                                <select class="form-control m-bot15" name="pid">
                                <option value="0">顶级分类</option>
                                <?php if(is_array($top)): $i = 0; $__LIST__ = $top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" aa="<?php echo ($info["pid"]); ?>" <?php if(($info["pid"]) == $vo["id"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">分类名称</label>
                            <div class="col-lg-10">
