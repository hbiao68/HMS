    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo U('Case/edit');?>">
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">案例分类</label>
                            <div class="col-lg-10">
                                <select class="form-control m-bot15" name="cid">
                                <?php if(is_array($cat)): $i = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" disabled="disabled" style="colot:#ddd;"><?php echo ($vo["name"]); ?></option>
                                <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><option value="<?php echo ($child["id"]); ?>" <?php if(($child["id"]) == $info["cid"]): ?>selected="selected"<?php endif; ?>>&nbsp;&nbsp;<?php echo ($child["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">案例标题</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["name"]); ?>" id="name" name="name" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="author" class="control-label col-lg-2">作者</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["author"]); ?>" id="author" name="author" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="author" class="control-label col-lg-2">案例链接</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group last">
								<label class="control-label col-lg-2" for="legal_id_img">案例封面</label>
								<div class="col-md-9">
						...
						<div class="form-group">
                        	...
                        	<div class="col-lg-10">
                            	<textarea class="form-control ckeditor" name="content" rows="6"><?php echo ($info["content"]); ?></textarea>
                            </div>
                        </div>
...
<script type="text/javascript" src="/Public/Static/Admin/js/ckeditor/ckeditor.js"></script>
<script>
	var uplodUrl = "<?php echo U('Case/ckeditorUplod');?>";
