    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="<?php echo U('AuthRule/edit');?>">
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">上级菜单</label>
                            <div class="col-lg-10">
                                <select class="form-control m-bot15" name="pid">
                                <option value="0">顶级菜单</option>
                                <?php if(is_array($top)): $i = 0; $__LIST__ = $top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $info["pid"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">功能名称</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["title"]); ?>" id="title" name="title"  type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">URL</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["url"]); ?>" id="url" name="url"  type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">是否在菜单栏显示</label>
                            <div class="col-lg-10">
                                <select class="form-control m-bot15" name="is_menu">
                                <option value="1" <?php if(($info["is_menu"]) == "1"): ?>selected="selected"<?php endif; ?>>显示</option>
                                <option value="2" <?php if(($info["is_menu"]) == "2"): ?>selected="selected"<?php endif; ?>>不显示</option>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                ...
                                <option value="1" <?php if(($info["status"]) == "1"): ?>selected="selected"<?php endif; ?>>开放</option>
                                <option value="2" <?php if(($info["status"]) == "2"): ?>selected="selected"<?php endif; ?>>关闭</option>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">图标<a href="<?php echo U('Icon/fontawesome');?>" target="_blank"> 《样例》</a></label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["icon"]); ?>" id="icon" name="icon"  type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">标识</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["mark"]); ?>" id="mark" name="mark"  type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="title" class="control-label col-lg-2">排序</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["sort"]); ?>" id="sort" name="sort"  type="text" />
                            </div>
                        </div>
