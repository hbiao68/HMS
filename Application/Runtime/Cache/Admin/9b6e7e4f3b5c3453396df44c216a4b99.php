            ...
            <header class="panel-heading">
                	后台用户列表
                        <span class="tools pull-right">
                        	<a href="<?php echo U('AdminUser/add');?>" class="fa">添加后台用户</a>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="numeric"><?php if(($vo["last_login_time"]) == "0"): else: echo (date("Y-m-d H:i:s",$vo["last_login_time"])); endif; ?></td>
                            <td class="numeric"><?php if(($vo["update_time"]) == "0"): else: echo (date("Y-m-d H:i:s",$vo["update_time"])); endif; ?></td>
                            <td class="numeric"><?php echo ($vo["last_login_ip"]); ?></td>
                            <td class="numeric"><a href="<?php echo U('AdminUser/edit',array('id'=>$vo['id']));?>" class="edit">修改</a></td>
