            ...
            <header class="panel-heading">
                	新闻列表
                        <span class="tools pull-right">
                        	<a href="<?php echo U('News/add');?>" class="fa">添加新闻</a>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="numeric"><a href="<?php echo U('News/edit',array('id'=>$vo['id']));?>" class="edit">修改</a> | <a href="<?php echo U('News/editStatus',array('id'=>$vo['id'],'status'=>2));?>" class="edit">移到回收站</a> | <a href="#" class="edit" target="_blank">预览</a></td>
