            ...
            <header class="panel-heading">
                	广告位列表
                        <span class="tools pull-right">
                        	<a href="<?php echo U('Advertisement/ad_locationAdd');?>" class="fa">添加广告位</a>
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php if(($vo["flag"]) == "1"): ?>可用<?php else: ?>不可用<?php endif; ?></td>
                            <td class="numeric"><a href="<?php echo U('Advertisement/ad_locationEdit',array('id'=>$vo['id']));?>" class="edit">修改</a></td>
