    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo U('SystemInfo/index');?>">
                       <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">网站域名</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($system["domain"]); ?>" id="domain" name="domain" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">联系电话</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($system["phone"]); ?>" id="phone" name="phone" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">联系QQ<br/>多个请用英文逗号（,）隔开</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($system["qq"]); ?>" id="qq" name="qq" type="text" />
                            </div>
                        </div>
						<div class="form-group">
							<label for="author" class="control-label col-lg-2">底部信息</label>
                        	<div class="col-lg-10">
                            	<textarea class="form-control ckeditor" name="footer_content" rows="6"><?php echo ($system["footer_content"]); ?></textarea>
                            </div>
                        </div>
						<div class="form-group">
