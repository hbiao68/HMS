...
<section>
    ...
    <div class="main-content" >
        ...
        <!-- page heading end-->
<!--icheck-->
<link href="/Public/Static/Admin/js/iCheck/skins/flat/green.css" rel="stylesheet">
<!--body wrapper start-->
<div class="wrapper">
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
				...
				<div class="panel-body">
					<div class="row">
						<form class="form-horizontal bucket-form" method="post" action="<?php echo U('AuthGroup/setRule');?>">
						<?php if(is_array($authRuleList)): $i = 0; $__LIST__ = $authRuleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rulelist): $mod = ($i % 2 );++$i;?><div class="col-md-6">
								<div class="form-group">
									<label class="col-sm-3 control-label"><?php echo ($rulelist["title"]); ?></label>
									<div class="col-sm-9 icheck ">
										<?php if(is_array($rulelist["child"])): $i = 0; $__LIST__ = $rulelist["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><div class="flat-green single-row">
											<div class="radio ">
												<input type="checkbox" name="rules[]" value="<?php echo ($child["id"]); ?>" <?php if(($child["is_rule"]) == "1"): ?>checked<?php endif; ?>> 
