    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo U('Page/edit');?>">
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">单页分类</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">单页标题</label>
                            <div class="col-lg-10">
                                <input class="form-control " value="<?php echo ($info["name"]); ?>" id="name" name="name" type="text" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">简介</label>
                            <div class="col-lg-10">
                                <textarea class="form-control" name="introduction" rows="6"><?php echo ($info["introduction"]); ?></textarea>
                            </div>
                        </div>
						<div class="form-group">
...
<script>
	var uplodUrl = "<?php echo U('Page/ckeditorUplod');?>";
