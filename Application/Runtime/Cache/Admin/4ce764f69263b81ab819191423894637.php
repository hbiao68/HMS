    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="<?php echo U('Advertisement/ad_locationEdit');?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                ...
                                <option value="1" <?php if(($list["flag"]) == "1"): ?>selected="selected"<?php endif; ?>>可用</option>
                                <option value="2" <?php if(($list["flag"]) == "2"): ?>selected="selected"<?php endif; ?>>不可用</option>
                            	</select>
                            </div>
                        </div>
