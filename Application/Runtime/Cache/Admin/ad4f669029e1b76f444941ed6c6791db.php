    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal adminex-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo U('MenuWeb/edit');?>">
                       <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-2">导航类型</label>
                            <div class="col-lg-10">
                                <select class="form-control m-bot15" name="tid">
                                <option value="1" <?php if(($info["tid"]) == "1"): ?>selected="selected"<?php endif; ?>>顶部</option>
                                <option value="2" <?php if(($info["tid"]) == "2"): ?>selected="selected"<?php endif; ?>>底部</option>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            <label for="name" class="control-label col-lg-2">链接</label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                ...
                                <option value="2" <?php if(($info["status"]) == "2"): ?>selected="selected"<?php endif; ?>>不可用</option>
                            	</select>
                            </div>
                        </div>
                        <div class="form-group ">
